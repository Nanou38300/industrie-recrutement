        ...
        if (empty($candidatures)) {
            ...
            foreach ($candidatures as $c) {
                ...
                foreach ($statuts as $s) {
                    ...
                    $options .= "<option value='{$this->safe($s)}'{$selected}>" . ucfirst($this->safe($s)) . "</option>";
                }
                ...
                echo "  <input type='hidden' name='id' value='" . $this->safe((string)($c['id'] ?? '')) . "'>";
                ...
                $commentRaw     = (string)($c['commentaire_admin'] ?? '');
                $commentAffiche = trim($commentRaw) !== ''
                    ? $this->safe($commentRaw)
        ...
        if (empty($candidatures)) {
            ...
            foreach ($candidatures as $c) {
                ...
                foreach ($etapes as $etape) {
                    ...
                    echo "<span class='etape {$active}'>" . $this->safe($etape) . "</span>";
                }
                echo "</div>";
                echo "</div><hr>";
            }
