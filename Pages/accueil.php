...
<figure>
    ...
    <figcaption>
        <section class="chiffre-compteur">
            ...
            <div class="compteur" data-target="5">0</div>
            <div class="compteur" data-target="45">0</div>
        </section>
...
<section  class="template-titre2">
        ...
        <div class="separateur2"></div>
        <p>Ils nous font confiance, à vous maintenant.</p>
</section>

<section class="cadre-vert">
    <p>INDUSTRIE</p>
    <p>CHIMIE</p>
    <div class="cadre-beige"><p>NUCLÉAIRE</p></div>
</section>
...
<section class="temoignage">
    ...
    <h3>☢️ Témoignage Client — Industrie nucléaire</h3>
    <p class="temoignage-texte">« Nous avons collaboré avec TCS Chaudronnerie dans le cadre de la rénovation partielle de notre installation classée nucléaire. Leur capacité à intégrer les exigences du RCC-M, à formaliser les DMOS/QMOS, et à assurer un suivi qualité rigoureux a été déterminante pour le succès du projet. Leurs soudeurs qualifiés et leur bureau d’études ont su répondre aux contraintes de sécurité, de documentation et de planification imposées par le secteur. La maîtrise technique et l’approche documentaire démontrent leur haut niveau de compétence dans le domaine nucléaire.»</p>
    <p class="temoignage-texte">— Ingénieur Projet Nucléaire, Opérateur énergétique français</p>
</section>
